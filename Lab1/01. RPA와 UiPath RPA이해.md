...
UiPath는 로보틱프로세스자동화(RPA)를위한소프트웨어플랫폼으로, 
Forrester, Gartner, IDC 등 주요 시장 조사기관에서RPA 분야의리더로
지속적으로선정되고있습니다. 특히, Gartner의매직쿼드런트에서는
지속적으로세계적인리더로자리잡고있고 기술력과시장점유율측면에서
높은평가를받고있습니다.
 UiPath 플랫폼은고객이비즈니스프로세스를명확히이해하고(발견), 그
프로세스를효과적으로자동화하며(자동화), 자동화된프로세스를원활하게
관리하고운영할수있게하는(운영) 능력을갖추고있습니다. UiPath는
비즈니스프로세스를자동화하기위해소프트웨어로봇을사용하며, 이를
통해업무효율성을극대화하고오류를줄이며운영비용을절감할수
있습니다.
 UiPath는 드래그앤드롭방식의직관적인시각적개발환경을제공하여, 
프로그래밍지식이없는사용자도쉽게자동화를설계하고구현할수
있습니다. 이로인해일반인들도직접업무자동화를구현할수있습니다
